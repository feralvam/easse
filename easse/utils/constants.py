...
TEST_SETS_PATHS = {
        ...
        ('newsela_test', 'orig'): DATA_DIR / f'test_sets/newsela/newsela.test.orig',
        ('newsela_test', 'refs'): [DATA_DIR / f'test_sets/newsela/newsela.test.simp'],
        ('newsela_valid', 'orig'): DATA_DIR / f'test_sets/newsela/newsela.valid.orig',
        ('newsela_valid', 'refs'): [DATA_DIR / f'test_sets/newsela/newsela.valid.simp'],
